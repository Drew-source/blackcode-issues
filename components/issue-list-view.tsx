...
type SortField = 'id' | 'title' | 'status' | 'priority' | 'created_at' | 'updated_at'
...
export function IssueListView({ issues, showProjectColumn = false }: IssueListViewProps) {
  ...
  }, [issues, searchQuery, statusFilter, priorityFilter, assigneeFilter, sortField, sortDirection])
    ...
    <div className="space-y-4">
      ...
      {filteredIssues.length === 0 ? (
        <div className="text-center py-16">
          <div className="inline-flex items-center justify-center w-12 h-12 bg-secondary rounded-xl mb-3">
