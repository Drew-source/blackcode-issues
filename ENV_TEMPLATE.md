...
## TaskHive Sync (Phase 1)

```env
TASKHIVE_API_URL=https://taskhive-pied.vercel.app
TASKHIVE_SERVICE_ACCOUNT_KEY=th_agent_<your_service_account_key>
TASKHIVE_WEBHOOK_SECRET=<shared_secret_for_webhook_signatures>
```
